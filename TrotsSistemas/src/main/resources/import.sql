-- inserir cidades
-- https://github.com/chandez/Estados-Cidades-IBGE/tree/master/sql
-- -- Create Table --
-- CREATE TABLE
--     Cidade (
--         idCidade INT NOT NULL SERIAL,
...
VALUES
    (
        ...
        25.00,
        100,
        'Erva mate de origem nativa sombreada, cor verde clara e sabor equilibrado.'
    ),
    (
        2,
        'Tereré Tradicional',
        ...
        15.00,
        100,
        'Erva para iniciantes, feita com folhas e partes do ramo de Ilex Paraguariensis.'
    ),
    (
        3,
        'Pura Folha',
        ...
        16.50,
        80,
        'Produzida apenas com folhas de erva mate. Ideal para quem já está acostumado com tereré.'
    ),
    (
        4,
        'Burrito',
        ...
        17.00,
        80,
        'Com erva mate e burrito, sabor com leve frescor, lembrando menta.'
    ),
    (
        5,
        'Supreme Fitx',
        'Complexo: canela, gengibre, hibisco, cravo e chá verde',
        500,
        18.50,
        60,
        'A mais complexa. Mistura harmônica de várias ervas com sabor enigmático e encorpado.'
    ),
    (
        6,
        'Menta & Limão',
        ...
        17.50,
        60,
        'Mistura de menta e limão desidratado. Cítrico unido à intensidade da menta.'
    ),
    (
        7,
        'Hortelã',
        ...
        17.00,
        60,
        'Blend suave e refrescante de erva mate com hortelã.'
    ),
    (
        8,
        'Menta Stronger',
        ...
        18.00,
        50,
        'Com folhas de menta e sabor vigoroso.'
    ),
    (
        9,
        'Menta & Boldo',
        ...
        17.80,
        50,
        'Mistura de boldo com menta. Potente e refrescante.'
    ),
    (
        10,
        'Menta & Cereja',
        ...
        18.00,
        50,
        'Equilíbrio entre potência da menta e frescor da cereja.'
    ),
    (
        11,
        'Eucalipto',
        'Mentolado com amargor suave',
        500,
        18.50,
        40,
        'Sabor marcante com notas mentoladas e toque amargo sutil.'
    );
...
-- INSERIR ENDEREÇOS 
-- idendereco, bairro, cep, cidade, complemento, logradouro, numero, referencia, uf
INSERT INTO public.endereco (
    idendereco, bairro, cep, cidade, complemento, logradouro, numero, referencia, uf
)
VALUES
(1, 'Centro', '29700-123', 'Colatina', 'Ap 1', 'Rua Principal', 101, 'Próximo à praça', 'ES'),
(2, 'Bairro das Sombras', '11000-000', 'São Paulo', NULL, 'Av. Trevas', 666, 'Perto do cemitério', 'SP'),
(3, 'Mortal Kombat', '15000-777', 'Macapá', 'Casa dos fundos', 'Rua Fatality', 99, NULL, 'AP'),
(4, 'Vila Verde', '13000-888', 'Campinas', NULL, 'Av. dos Ossos', 13, 'Atrás da farmácia', 'SP'),
(5, 'Jardim Ervas', '21000-420', 'São Luís', NULL, 'Rua Natureza', 420, 'Ao lado do mercado natural', 'MA'),
(6, 'Zona Rural', '12000-001', 'Rio Branco', NULL, 'Estrada do Matão', 7, 'Sítio do Zé', 'AC'),
(7, 'Bairro Industrial', '17210-555', 'Jaú', NULL, 'Av. das Ferramentas', 22, 'Oficina do lado', 'SP'),
(8, 'Bairro Realidade', '28029-000', 'Aracaju', NULL, 'Rua do Rap', 197, 'Perto da quebrada', 'SE'),
(9, 'Bairro das Águas', '26116-030', 'Belford Roxo', NULL, 'Rua do Peixe', 40, 'Mercado de peixe', 'RJ'),
(10, 'Bairro das Amazonas', '35503-089', 'São Paulo', 'Bloco B', 'Rua das Valquírias', 123, 'Condomínio das Guerreiras', 'SP');
